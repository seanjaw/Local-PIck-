          ...
          <View style={{ flex: 1 }}>
            ...
            <View>
              {this.state.loginModal == true ? (
                <View >
                  <View style={{ position: 'absolute', backgroundColor: 'black', top: 0, left: 0, right: 0, bottom: 0, height: 240, zIndex: 1, opacity: .9, justifyContent: 'space-around', alignItems: 'center' }}>
                    <View style={{ top: 55 }}>
                      <Text style={{ padding: 10, fontSize: 50, borderColor: 'white', borderWidth: 2, color: 'white', textAlign: 'center', width: 340 }}>Local Pick</Text>
                    </View>
